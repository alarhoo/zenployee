					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee Maintainace Tool",
									"targetURL": "#zenployee-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zenployee-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zenployee",
									"url": sap.ui.require.toUrl("zenployee")
								}
							}
						}
					}
